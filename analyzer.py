...
UB - безэкипажный катер (UB можно использовать только в регионах: Республика Крым, Севастополь, Краснодарский край, Херсонская область, Запорожская область, Донецкая Народная Республика, Ростовская область)
ALL - все опасности.
...
- Сообщения типа "За прошедшую ночь силами противовоздушной обороны было уничтожено N БПЛА" и дальнейшее перечисление регионов игнорировать, в виде результата давать пустую строку.
- Сообщения типа "Движение автотранспорта по Крымскому мосту возобновлено" игнорировать (выводить пустую строку).
- Сообщения типа "Поздравляем вас с праздником H", подобные сообщения, и другие сообщения, не содержащие необходимой информации, игнорировать (выводить пустую строку).
